// extractGridColors.js — Shared grid color extraction logic
// Used by main.js for synchronous pre-extraction during export.
// The web worker (color-extraction-worker.js) keeps its own copy.

export function extractGridColors(imageData, gridColumns, gridRows) {
